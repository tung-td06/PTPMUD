...
public class TableDetailController implements Initializable {
    ...
    private void loadDataFromServer() {
        ...
        new Thread(() -> {
            try {
                ...
                final String trangThaiBan = (banAn != null) ? banAn.getTrangThai() : "Tr\u1ed1ng";
                final BanAn finalBanAn = banAn;

                // 2. Dua theo trang thai, load chi tiet tuong ung
                if ("\u0110ang d\u00f9ng".equalsIgnoreCase(trangThaiBan) || "C\u00f3 kh\u00e1ch".equalsIgnoreCase(trangThaiBan)) {
                    loadOccupiedData(finalBanAn);
                } else if ("\u0110\u1eb7t tr\u01b0\u1edbc".equalsIgnoreCase(trangThaiBan) || "\u0110\u00e3 \u0111\u1eb7t".equalsIgnoreCase(trangThaiBan)) {
        ...
        new Thread(() -> {
            try {
                ...
                Platform.runLater(() -> {
                        ...
                        if (dbList != null) {
                            ...
                            for (DatBan db : dbList) {
                                if (db.getTimeVao() != null && db.getTimeRa() != null) {
                                    ...
                                    boolean isCompleted = "Ho\u00e0n th\u00e0nh".equalsIgnoreCase(db.getTrangThai());
                    ...
                    String timeXacNhanStr = "Ch\u01b0a \u0111\u1ebfn";
                    ...
                    if (activeDB != null) {
                        if (activeDB.getMaKH() != null && !activeDB.getMaKH().trim().isEmpty()) {
                            ...
                            if (matchedKH != null) {
                                ...
                                sdt = matchedKH.getSdt() != null && !matchedKH.getSdt().trim().isEmpty()
                                        ? matchedKH.getSdt() : "Ch\u01b0a c\u00f3 d\u1eef li\u1ec7u";
                            } else {
                        ...
                        lblGhiChu.setText((activeDB.getNote() != null && !activeDB.getNote().trim().isEmpty())
                                ? activeDB.getNote() : "Kh\u00f4ng c\u00f3 ghi ch\u00fa");
                    }
    ...
    private void updateGeneralInfo(BanAn banAn) {
        ...
        if ("\u0110ang d\u00f9ng".equalsIgnoreCase(status) || "C\u00f3 kh\u00e1ch".equalsIgnoreCase(status)) {
            lblTrangThai.setStyle("-fx-text-fill: #ef4444; -fx-font-weight: bold;");
        } else if ("\u0110\u1eb7t tr\u01b0\u1edbc".equalsIgnoreCase(status) || "\u0110\u00e3 \u0111\u1eb7t".equalsIgnoreCase(status)) {
