...
public class BillController implements Initializable {
            ...
            try {
                ...
                Platform.runLater(() -> {
                    if (billRes != null && billRes.isSuccess()) {
                        ...
                        showAlert(billRes != null ? billRes.getMessage()
                                : "Mất kết nối Server. Không thể tải danh sách hóa đơn!");
                    }
    ...
    public static class BillModel {
        ...
        public String getTimeVaoStr() {
            return timeVaoStr;
        }

        public String getTimeRaStr() {
            return timeRaStr;
        }
    ...
    private void handleAddNew() {
        showAlert("Nhân viên không có quyền tạo hóa đơn mới!");
    }
    ...
    private void handleDelete() {
        showAlert("Nhân viên không có quyền xóa hóa đơn!");
    }
    ...
    private void navigate(String fxmlPath) {
        try {
            ...
            javafx.scene.layout.AnchorPane parent = (javafx.scene.layout.AnchorPane) billTable.getScene()
                    .lookup("#contentArea");
            if (parent != null) {
