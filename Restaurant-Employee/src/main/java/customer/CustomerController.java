...
public class CustomerController implements Initializable {
                ...
                Platform.runLater(() -> {
                    if (response != null && response.isSuccess()) {
                        ...
                        showAlert(response != null ? response.getMessage()
                                : "Mất kết nối Server. Không thể tải danh sách khách hàng!");
                    }
    ...
    private void handleAddNew() {
        showAlert("Nhân viên không có quyền thêm mới khách hàng!");
    }

    @FXML
    private void handleEdit() {
        showAlert("Nhân viên không có quyền chỉnh sửa thông tin khách hàng!");
    }

    @FXML
    private void handleDelete() {
        showAlert("Nhân viên không có quyền xóa khách hàng!");
    }
