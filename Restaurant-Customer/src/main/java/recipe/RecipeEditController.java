    ...
    private void handleSave(ActionEvent event) {
        ...
        try {
            ...
            if (keyChanged) {
                ...
                // Add the new record
                model.DinhLuongMon newRecipe = new model.DinhLuongMon(newMamon, newManguyenlieu, dinhLuongVal);
                ...
                if (addRes != null && addRes.isSuccess()) {
                    ...
                    selectedRecipe = new RecipeController.RecipeModel(
                        ...
                        dinhluongStr + (selectedRecipe.getDonViTinh().isEmpty() ? "" : " " + selectedRecipe.getDonViTinh()),
                        dinhLuongVal, selectedRecipe.getDonViTinh()
                    );
                ...
                model.DinhLuongMon updated = new model.DinhLuongMon(newMamon, newManguyenlieu, dinhLuongVal);
